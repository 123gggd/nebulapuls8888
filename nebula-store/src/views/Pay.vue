          ...
          <div class="order-info">
            ...
            <div class="text">
              ...
              <p class="expire-tip" v-else>
                请在 <span style="color: #f56c6c; font-weight: bold">{{ formatTime(timeLeft) }}</span> 内完成支付，否则订单将自动取消
              </p>
            </div>
            <div class="amount">
          ...
          <div class="qr-code-area">
            <div class="qr-box">
              ...
              <el-button
                  ...
                  :loading="paying"
                  @click="handlePay"
                  style="width: 220px; margin-top: 20px; font-weight: bold;"
              >
...
.pay-card { border-radius: 8px; min-height: 600px; }
...
.pay-methods {
  margin-top: 30px;
  .method-title { font-weight: bold; margin-bottom: 20px; font-size: 16px; border-left: 4px solid #409EFF; padding-left: 10px; }
  .method-list {
    display: flex;
    gap: 20px;
    .method-item {
